...
export const OPEN_SHARE_LINK_POPUP = 'OPEN_SHARE_LINK_POPUP';
export const CLOSE_SHARE_LINK_POPUP = 'CLOSE_SHARE_LINK_POPUP';

export const SAVE_FEEDBACK = 'CSAVE_FEEDBACK';

export const DRAWER_SWIPE_AREA_WIDTH = 30;
